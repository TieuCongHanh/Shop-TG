...
import com.example.appbanhangtg.databinding.FragmentStarProduct4Binding
import com.example.appbanhangtg.databinding.FragmentStarShop4Binding

private lateinit var binding:FragmentStarProduct4Binding
class StarProduct4 : Fragment() {
    ...
    companion object {
        fun newInstance(productWrapper: ProductWrapper): StarProduct4 {
            val fragment = StarProduct4()
            val args = Bundle()
    ...
    override fun onCreateView(
       ...
       binding = FragmentStarProduct4Binding.inflate(inflater, container, false)
        list()
    ...
    private fun list(){
        ...
        val voteCount = shopId?.let {
            voteProductDAO.getStarCoun4tById(it)
        }
