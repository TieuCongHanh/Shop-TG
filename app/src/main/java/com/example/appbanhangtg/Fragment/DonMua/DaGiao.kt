...
import com.example.appbanhangtg.databinding.FragmentDaGiaoBinding
...
class DaGiao : Fragment() , OnDataChangedListener {
    ...
    private fun loadDataAndUpdateUI() {
        ...
        }?.filter { it.TTXacNhan == "true" && it.TTLayhang =="true" && it.TTHuy == "false" && it.TTDaGiao =="true" } // Thay "Trạng thái cần lọc" bằng giá trị cụ thể
