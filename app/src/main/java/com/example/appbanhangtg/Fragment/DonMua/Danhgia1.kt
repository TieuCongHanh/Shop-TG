...
import com.example.appbanhangtg.databinding.FragmentDanhgia1Binding

private lateinit var binding:FragmentDanhgia1Binding
class Danhgia1 : Fragment() , OnDataChangedListener {
    ...
    override fun onCreateView(
        ...
        binding = FragmentDanhgia1Binding.inflate(inflater, container, false)
