...
import com.example.appbanhangtg.databinding.FragmentLayHangBinding

private lateinit var binding:FragmentLayHangBinding
class LayHang : Fragment() , OnDataChangedListener {
    ...
    private fun loadDataAndUpdateUI() {
        ...
        val billList = userId?.let {
            ...
            ?.filter { it.TTXacNhan == "true" && it.TTLayhang == "false" && it.TTHuy == "false"} // Thay "Trạng thái cần lọc" bằng giá trị cụ thể
    ...
    override fun onCreateView(
        ...
        binding = FragmentLayHangBinding.inflate(inflater, container, false)
