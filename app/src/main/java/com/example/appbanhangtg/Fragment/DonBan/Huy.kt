...
import com.example.appbanhangtg.databinding.FragmentHuy2Binding

private lateinit var binding:FragmentHuy2Binding
class Huy : Fragment(), OnDataChangedListener {
    ...
    override fun onCreateView(
        ...
        binding = FragmentHuy2Binding.inflate(inflater,container,false)
        loadDataAndUpdateUI()
