...
class VoteProductAdapter (
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): VoteProductAdapter.VoteProductHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_vote_shop, parent, false)
        return VoteProductHolder(view)
    }

    override fun onBindViewHolder(holder: VoteProductAdapter.VoteProductHolder, position: Int) {
